...
class ImageUrlHelper {
  ...
  /// 
  /// [fileName] Nome do arquivo (ex: "exibicoes-produto/original/abc123.jpg")
  /// Retorna a URL completa ou null se fileName for null/vazio
  static String? getOriginalImageUrl(String? fileName) {
    if (fileName == null || fileName.isEmpty) return null;
    
    // Garantir que s3BaseUrl não tenha barra final e fileName não comece com barra
  ...
  /// 
  /// [fileName] Nome do arquivo original (ex: "exibicoes-produto/original/abc123.jpg")
  ...
  static String? getThumbnailImageUrl(String? fileName) {
    ...
    String thumbnailPath = fileName.replaceAll('/original/', '/thumbnails/');
    
    // Se não encontrou /original/, tenta substituir original/ por thumbnails/
    if (thumbnailPath == fileName) {
      thumbnailPath = fileName.replaceAll('original/', 'thumbnails/');
    }
