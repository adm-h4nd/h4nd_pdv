...
/// Tela para realizar sangria (débito) do caixa
class SangriaCaixaScreen extends StatefulWidget {
  final CicloCaixaDto cicloCaixa;

  const SangriaCaixaScreen({
    super.key,
    required this.cicloCaixa,
  });

  @override
  State<SangriaCaixaScreen> createState() => _SangriaCaixaScreenState();
}

class _SangriaCaixaScreenState extends State<SangriaCaixaScreen> {
  ...
  Future<void> _salvar() async {
    ...
    try {
      ...
      final response = await cicloCaixaService.sangriaCicloCaixa(
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Sangria realizada com sucesso!'),
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Conta Destino: ${widget.cicloCaixa.contaOrigemNome}',
                      style: GoogleFonts.inter(
                        fontSize: 14,
                        color: AppTheme.textSecondary,
                      ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Apenas dinheiro físico pode ser retirado do caixa',
                              style: GoogleFonts.inter(
                                fontSize: 12,
                                color: AppTheme.warningColor,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: '0,00',
                  prefixIcon: Icon(Icons.remove_circle_outline, color: AppTheme.errorColor),
              ...
              TextFormField(
                ...
                maxLines: 3,
                decoration: InputDecoration(
                  hintText: 'Adicione observações sobre esta sangria...',
                  prefixIcon: Icon(Icons.note, color: AppTheme.errorColor),
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                  ),
                  filled: true,
